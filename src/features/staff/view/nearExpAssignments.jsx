...
import {useGetAssignmentsNearExpirationsQuery} from "../model/ass.stats.api.slice";
...
const NearExpAssignments = () => {
  ...
  const {data: agents=[], isLoading, isFetching, isError, error, refetch}
  ...
  return (
    <ErrorBoundary fallbackRender={FallBackRender}>
      <PageHeading title='Affectations proche expiration'/>
      <PageLayout>
        <AppBreadcrumb title='Affectations proche expiration'/>
        ...
        <Card>
          <Card.Header className='bg-white pt-5'>
            <Card.Title>
              ...
              <i className='bi bi-bookmark-check text-primary'/> Affectations proche expiration
            </Card.Title>
...
export default memo(NearExpAssignments)
