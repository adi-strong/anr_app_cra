...
import {useGetCurrentMissionsQuery} from "../model/mission.stats.api.service";
...
const CurrentMissions = () => {
  ...
  const {data: agents=[], isLoading, isFetching, isError, error, refetch} = useGetCurrentMissionsQuery('LIST')
  ...
  return (
    <ErrorBoundary fallbackRender={FallBackRender}>
      <PageHeading title='Missions en cours'/>
      <PageLayout>
        <AppBreadcrumb title='Missions en cours'/>
        ...
        <Card>
          <Card.Header className='bg-white pt-5'>
            <Card.Title>
              ...
              <i className='bi bi-brightness-high text-primary'/> Missions en cours
            </Card.Title>
...
export default memo(CurrentMissions)
