...
import {assignment2Items} from "../model/assignment.service";
import Assignment2Item from "./assignment2Item";
import {
  nbAssignmentsPages,
  useGetAssignmentsListQuery,
  useLazyGetPaginatedAssignmentsListQuery
} from "../model/ass.api.slice";
...
export default function AssignmentsList() {
  ...
  const {data: agents = [], isLoading, isFetching, isError, error, refetch} = useGetAssignmentsListQuery(nbPages)
