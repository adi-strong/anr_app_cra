...
import {useGetRetiredAgentsQuery} from "../model/agent.stats.api.service";
...
const RetiredAgents = () => {
  ...
  const {data: agents=[], isLoading, isFetching, isError, error, refetch} = useGetRetiredAgentsQuery('LIST')
        ...
        <Card>
          <Card.Header className='bg-white pt-5'>
            <Card.Title>
              ...
              <i className='bi bi-person-up text-primary'/> Liste des agents retraités
            </Card.Title>
...
export default memo(RetiredAgents)
