...
import {useGetMissionsNerExpirationsQuery} from "../model/mission.stats.api.service";
...
const NearExpMissions = () => {
  ...
  const {data: agents=[], isLoading, isFetching, isError, error, refetch} = useGetMissionsNerExpirationsQuery('LIST')
  ...
  return (
    <ErrorBoundary fallbackRender={FallBackRender}>
      <PageHeading title='Missions proches expiration'/>
      <PageLayout>
        <AppBreadcrumb title='Missions proches expiration'/>
        ...
        <Card>
          <Card.Header className='bg-white pt-5'>
            <Card.Title>
              ...
              <i className='bi bi-brightness-alt-high text-primary'/> Missions proches expiration
            </Card.Title>
...
export default memo(NearExpMissions)
