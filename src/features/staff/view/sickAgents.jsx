...
import {useGetSickAgentsQuery} from "../model/agent.stats.api.service";
...
const SickAgents = () => {
  ...
  const {data: agents=[], isLoading, isFetching, isError, error, refetch} = useGetSickAgentsQuery('LIST')
  ...
  return (
    <ErrorBoundary fallbackRender={FallBackRender}>
      <PageHeading title='Agents malades'/>
      <PageLayout>
        <AppBreadcrumb title='Agents malades'/>
        ...
        <Card>
          <Card.Header className='bg-white pt-5'>
            <Card.Title>
              ...
              <i className='bi bi-heart-pulse text-primary'/> Liste des agents malades
            </Card.Title>
...
export default memo(SickAgents)
