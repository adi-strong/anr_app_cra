...
export default function DoctorPrescriptionItem({data}) {
  return (
    <ErrorBoundary fallbackRender={FallBackRender}>
      <tr>
        <td className="align-middle">1</td>
        <td className="align-middle">
          <Link to={`/app/doctors-prescriptions/${1}/show`}>CONSULTATION GÉNÉRALE</Link>
        </td>
        <td className="align-middle">
        ...
        <td className="align-middle text-end">
          <Link to={`/app/doctors-prescriptions/${1}/show`}><i className='bi bi-link'/></Link>
        </td>
      </tr>
    </ErrorBoundary>
  )
