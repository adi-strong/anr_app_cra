...
export default function PrescriptionItem({data}) {
  return (
    <ErrorBoundary fallbackRender={FallBackRender}>
      <tr>
        <td className="align-middle">
          <Link to={`/app/nursing/${1}/show`}>CONSULTATION GÉNÉRALE</Link>
        </td>
        <td className="align-middle">
          <div className="d-flex align-items-center">
            ...
            <div className="ms-3 lh-1">
              <h5 className=" mb-1">
                <Link to={`/app/prescriptions/${1}/show`} className='text-dark'>
                  Anita Parmar
                </Link>
              </h5>
              <p className="mb-0">
        ...
        <td className="align-middle text-end">
          <Link to={`/app/prescriptions/${1}/show`}>
