...
import {useAddGradeMutation} from "../model/department.api.slice";
...
export default function AddGradesForm({onHide, data, department, onRefresh}) {
  const [validated, setValidated] = useState(false)
  const [fields, setFields] = useState(finCategories)
  const [addGrade, {isLoading}] = useAddGradeMutation()
...
AddGradesForm.propTypes = { onHide: PropTypes.func.isRequired }
