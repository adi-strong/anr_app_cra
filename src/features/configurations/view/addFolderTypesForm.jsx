...
import {usePostNewFolderTypeMutation} from "../model/folder.type.api.slice";

export default function AddFolderTypesForm({onHide, pages, onRefresh}) {
  const [validated, setValidated] = useState(false)
  const [fields, setFields] = useState(finCategories)
  const [postNewFolderType, {isLoading}] = usePostNewFolderTypeMutation()
...
AddFolderTypesForm.propTypes = { onHide: PropTypes.func.isRequired }
