...
import {usePostNewSocietyTypeMutation} from "../../recoveries/model/society.type.api.service";

export default function AddSocietyTypesForm({onHide, pages, onRefresh}) {
  const [validated, setValidated] = useState(false)
  const [fields, setFields] = useState(finCategories)
  const [postNewSocietyType, {isLoading}] = usePostNewSocietyTypeMutation()
...
AddSocietyTypesForm.propTypes = { onHide: PropTypes.func.isRequired }
