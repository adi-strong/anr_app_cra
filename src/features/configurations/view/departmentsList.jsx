...
export default function DepartmentsList() {
  ...
  const {data: departments = [], isLoading, isFetching, isError, error, refetch} = useGetDepartmentsListQuery(nbPages)
  ...
  return (
    <ErrorBoundary fallbackRender={FallBackRender}>
      ...
      <div>
        ...
        {!isSearched && nbDepartmentsPages > 1 &&
      ...
      <AppOffCanvas
        ...
        children={<AddDepartmentsForm onHide={toggleShow} pages={nbPages} onRefresh={onProvinceRefresh}/>}/>
    </ErrorBoundary>
  )
}
