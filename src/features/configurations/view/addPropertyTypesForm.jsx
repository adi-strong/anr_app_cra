...
import {usePostNewPropertyTypeMutation} from "../../properties/model/property.type.api.slice";

export default function AddPropertyTypesForm({onHide, pages, onRefresh}) {
  const [validated, setValidated] = useState(false)
  const [fields, setFields] = useState(finCategories)
  const [postNewPropertyType, {isLoading}] = usePostNewPropertyTypeMutation()
...
AddPropertyTypesForm.propTypes = { onHide: PropTypes.func.isRequired }
