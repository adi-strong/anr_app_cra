...
import {onAddSubDepSubmit} from "../model/department.service";
import {
...
export default function AddSubDepsForm({onHide, data, department, onRefresh}) {
...
AddSubDepsForm.propTypes = { onHide: PropTypes.func.isRequired }
