...
import {useEditSocietyTypeMutation} from "../../recoveries/model/society.type.api.service";

export default function EditSocietyTypeForm({data, onRefresh, onHide}) {
  const [fields, setFields] = useState({name: ''})
  const [errors, setErrors] = useState({name: null})
  const [validate, setValidate] = useState(false)
  const [editPropertyType, {isLoading, isError, error}] = useEditSocietyTypeMutation()
